...
<head>
    ...
    <title>Portal BK — Virtual Counselor</title>
    ...
    <style>
        ...
        .neo-input:focus, .form-control.neo-input:focus, .form-select.neo-input:focus {
            outline: none;
            border-color: var(--primary);
            box-shadow: 0 0 0 3px rgba(193,140,93,0.15);
            background: white;
        }
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .org-nav-sublink:hover, .org-nav-sublink.active-sub {
        ...
        .org-logout-btn {
            ...
            border-radius: 14px;
            background: none; border: none; cursor: pointer;
            color: var(--destructive); font-size: 0.82rem; font-weight: 600;
            font-family: 'Nunito', sans-serif;
            transition: all 0.25s ease;
        }
        ...
        .org-card-accent {
            ...
            box-shadow: 0 4px 20px -2px rgba(193,140,93,0.12);
        }
        ...
        .org-btn-warning {
            background: #E8A838;
            color: white;
            box-shadow: 0 4px 16px -2px rgba(232,168,56,0.3);
        }
        .org-btn-warning:hover { transform: scale(1.04); color: white; }
        .org-btn-dark {
            background: var(--fg);
            color: white;
        }
        .org-btn-dark:hover { transform: scale(1.04); color: white; }
        .org-btn-ghost {
        ...
        .org-badge-warning { background: rgba(232,168,56,0.15); color: #8A6400; }
        .org-badge-success { background: rgba(93,112,82,0.12); color: var(--primary); }
        .org-badge-danger  { background: rgba(168,84,72,0.1); color: var(--destructive); }
        ...
        .org-feed-item:hover { background: rgba(230,220,205,0.2); }
        ...
        .pulse-dot {
            ...
            background: #5D7052; display: inline-block;
...
<button class="org-mobile-toggle" id="mobileToggle" onclick="toggleSidebar()">
...
<aside class="org-sidebar" id="sidebar">
    ...
    <a class="org-brand" href="{{ route('dashboard') }}">
        ...
        <div>
            <div class="org-brand-name">Portal BK</div>
    ...
    <div class="org-user-card">
        <div class="org-user-avatar">{{ substr(auth()->user()->name ?? 'B', 0, 1) }}</div>
        <div>
            <div class="org-user-name">{{ auth()->user()->name }}</div>
            <div class="org-user-role">GURU BK</div>
        </div>
    </div>
